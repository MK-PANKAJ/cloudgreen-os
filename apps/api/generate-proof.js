...
async function generateProof() {
  try {
    ...
    const { default: wc } = await import('./EmissionRangeProof_js/witness_calculator.js');
    ...
    console.log(JSON.stringify(proofForAPI, null, 2));
    console.log('\nPublic Signals:');
    console.log(JSON.stringify(publicSignalsForAPI, null, 2));
